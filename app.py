...
def create_venue_submission():
  ...
  try:
      ...
      venue.looking_for_talents = request.form['looking_for_talents']
      venue.seeking_description = request.data['seeking_description']
...
def show_artist(artist_id):
  ...
  past_shows = list(filter(lambda x: x.start_time < datetime.today(), artist.shows))  #Anoymouse function that filters past shows
...
def edit_artist_submission(artist_id):
  ...
  try:
      ...
      artist.looking_for_venues = request.form['looking_for_venues']
